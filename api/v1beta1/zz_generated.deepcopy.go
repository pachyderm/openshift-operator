...
func (in *ObjectStorageOptions) DeepCopyInto(out *ObjectStorageOptions) {
	*out = *in
	if in.AmazonStorage != nil {
		in, out := &in.AmazonStorage, &out.AmazonStorage
		*out = new(AmazonStorageOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.GoogleStorage != nil {
		in, out := &in.GoogleStorage, &out.GoogleStorage
		*out = new(GoogleStorageOptions)
		**out = **in
	}
	if in.MicrosoftStorage != nil {
		in, out := &in.MicrosoftStorage, &out.MicrosoftStorage
		*out = new(MicrosoftStorageOptions)
		**out = **in
	}
	if in.MinioStorage != nil {
		in, out := &in.MinioStorage, &out.MinioStorage
		*out = new(MinioStorageOptions)
		**out = **in
	}
...
func (in *PachydermSpec) DeepCopyInto(out *PachydermSpec) {
	*out = *in
	...
	if in.Pachd != nil {
		in, out := &in.Pachd, &out.Pachd
		*out = new(PachdOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.Dashd != nil {
		in, out := &in.Dashd, &out.Dashd
		*out = new(DashOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.Worker != nil {
